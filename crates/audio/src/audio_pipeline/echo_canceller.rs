#[cfg(not(any(all(target_os = "windows", target_env = "gnu"), target_os = "freebsd", target_os = "aros")))]
...
#[cfg(any(all(target_os = "windows", target_env = "gnu"), target_os = "freebsd", target_os = "aros"))]
