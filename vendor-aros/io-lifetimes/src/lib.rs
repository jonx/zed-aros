...
#![cfg(any(unix, windows, target_os = "wasi", target_os = "hermit", target_os = "aros"))]
#![cfg_attr(docsrs, feature(doc_cfg))]

mod portability;
mod traits;

#[cfg(any(unix, target_os = "wasi", target_os = "hermit", target_os = "aros"))]
#[allow(deprecated)]
...
// AROS is not `unix`, but its std exposes the fd types under std::os::fd.
#[cfg(target_os = "aros")]
