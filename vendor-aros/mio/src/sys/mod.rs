...
// AROS has no os-poll backend (not unix/windows/wasi); use the shell stub even
// when the os-poll feature is on (networking is stubbed on AROS).
#[cfg(all(feature = "os-poll", target_os = "aros"))]
mod shell;
#[cfg(all(feature = "os-poll", target_os = "aros"))]
